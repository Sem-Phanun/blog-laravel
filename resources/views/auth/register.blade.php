    ...
    <div class="flex justify-center">
        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <article class="text-3xl p-6">
                <h1 class="text-center uppercase">register</h1>
            </article>
            <form action="{{ route('register')}}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" value="" placeholder="confirm password"
                        class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('confirm_password')border-red-500 @enderror"
                    >
                ...
                <div class="flex items-center m-6">
                    <p>you have an account?</p> <a href="{{ route('login') }}" class="px-4 underline text-blue-600">login</a>
                </div>
            </form>
        </div>
    </div>
